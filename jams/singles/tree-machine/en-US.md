---
title: 'Draw your own Tree using p5.js'
description: >
  This Jam will go through the basics of p5.js and show you how to write recursive functions to draw a fractal tree.
contributor: 'polytroper'
thumbnail: 'https://cloud-bor29hmzm-hack-club-bot.vercel.app/0demo-5.png'
timeEstimate: '60 Min'
difficulty: 'Intermediate'
keywords: 'html, css, js, p5.js, recursion, fractal, tree, fractal tree, fractal trees, fractal tree generator, fractal tree maker, fractal tree drawing, fractal tree drawing program, fractal tree drawing generator, fractal tree drawing maker, fractal tree drawing program, fractal tree drawing code, fractal tree drawing tutorial, fractal tree drawing algorithm, fractal tree drawing java, fractal tree drawing software, fractal tree drawing program, fractal tree'
...
In `draw` we create a black background. You can play around with the numbers to change different aspects of your tree from color to thickness.
